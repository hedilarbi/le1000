...
<div id="m1000-root" style={{ position: "relative", background: "#0D0E0E" }}><section id="hero" data-screen-label="Hero" style={{ position: "relative", height: "100svh", minHeight: 600, overflow: "hidden", display: "flex", flexDirection: "column", justifyContent: "flex-end" }}>
    <div id="m1000-heroimg" style={{ position: "absolute", inset: "-22% 0", transform: "scale(1.06)", willChange: "transform" }}>
      <img src="https://images.pexels.com/photos/5490965/pexels-photo-5490965.jpeg?auto=compress&cs=tinysrgb&w=1800" alt="Photo int\xE9rieure \u2014 bar central, bois et lumi\xE8re chaude (paysage, 2400px)" loading="lazy" decoding="async" style={{ display: "block", width: "100%", height: "100%", objectFit: "cover" }} />
    </div>
    ...
    <div style={{ position: "relative", display: "grid", gridTemplateColumns: "repeat(12,1fr)", gap: "clamp(24px,3vw,48px)", maxWidth: 1440, margin: "0 auto" }}>
      ...
      <div id="m1000-intro-media" style={{ gridColumn: "7 / span 6", position: "relative" }}>
        <div data-reveal="mask" style={{ position: "relative", width: "100%", aspectRatio: "4 / 5", overflow: "hidden" }}>
          <img src="https://images.pexels.com/photos/30479386/pexels-photo-30479386.jpeg?auto=compress&cs=tinysrgb&w=1800" alt="Vue d\u2019ensemble de la salle (portrait 4:5)" loading="lazy" decoding="async" style={{ display: "block", width: "100%", height: "100%", objectFit: "cover" }} />
        </div>
        <div data-reveal="mask" data-delay="220" data-parallax="-0.05" id="m1000-intro-detail" style={{ position: "absolute", left: "-14%", bottom: "-9%", width: "46%", aspectRatio: "1 / 1", overflow: "hidden", border: "1px solid rgba(242,239,232,.07)", boxShadow: "0 30px 80px rgba(0,0,0,.55)" }}>
          <img src="https://images.pexels.com/photos/6503578/pexels-photo-6503578.jpeg?auto=compress&cs=tinysrgb&w=1800" alt="D\xE9tail \u2014 bois, verres ou plante suspendue (carr\xE9)" loading="lazy" decoding="async" style={{ display: "block", width: "100%", height: "100%", objectFit: "cover" }} />
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="experience" data-screen-label="Exp\xE9rience" style={{ position: "relative", minHeight: "100svh", display: "flex", alignItems: "center", overflow: "hidden", background: "#0D0E0E" }}>
    <div id="m1000-expimg" style={{ position: "absolute", inset: "-24% 0", willChange: "transform" }}>
      <img src="https://images.pexels.com/photos/5490818/pexels-photo-5490818.jpeg?auto=compress&cs=tinysrgb&w=1800" alt="Grande photo du bar central en soir\xE9e (paysage, 2400px)" loading="lazy" decoding="async" style={{ display: "block", width: "100%", height: "100%", objectFit: "cover" }} />
    </div>
  ...
  <section id="menu" data-screen-label="Aper\xE7u du menu" style={{ position: "relative", padding: "clamp(90px,14vh,180px) clamp(20px,5vw,80px)", background: "#1A1A1A" }}>
    <div style={{ maxWidth: 1440, margin: "0 auto" }}>
      ...
      <div id="m1000-menugrid" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "clamp(14px,1.6vw,26px)" }}>
        <a href="/menu" data-card="1" data-reveal="up" style={{ position: "relative", display: "block", aspectRatio: "3 / 4", overflow: "hidden", background: "#0D0E0E" }}>
          <div data-zoom="1" style={{ position: "absolute", inset: "0", transition: "transform 1.2s cubic-bezier(.16,.84,.24,1)" }}>
            <img src="https://images.pexels.com/photos/35495061/pexels-photo-35495061.jpeg?auto=compress&cs=tinysrgb&w=1800" alt="Plat de cuisine (portrait 3:4)" loading="lazy" decoding="async" style={{ display: "block", width: "100%", height: "100%", objectFit: "cover" }} />
          </div>
        ...
        <a href="/menu" data-card="1" data-reveal="up" data-delay="140" style={{ position: "relative", display: "block", aspectRatio: "3 / 4", overflow: "hidden", background: "#0D0E0E" }}>
          <div data-zoom="1" style={{ position: "absolute", inset: "0", transition: "transform 1.2s cubic-bezier(.16,.84,.24,1)" }}>
            <img src="https://images.pexels.com/photos/36366519/pexels-photo-36366519.jpeg?auto=compress&cs=tinysrgb&w=1800" alt="Cocktails au bar (portrait 3:4)" loading="lazy" decoding="async" style={{ display: "block", width: "100%", height: "100%", objectFit: "cover" }} />
          </div>
          <div style={{ position: "absolute", inset: "0", background: "linear-gradient(180deg,rgba(13,14,14,.1) 30%,rgba(13,14,14,.88) 100%)", pointerEvents: "none" }} />
          <div style={{ position: "absolute", inset: "auto 0 0 0", display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 16, padding: "clamp(20px,2vw,32px)", pointerEvents: "none" }}>
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
        ...
        <a href="/menu" data-card="1" data-reveal="up" data-delay="280" style={{ position: "relative", display: "block", aspectRatio: "3 / 4", overflow: "hidden", background: "#0D0E0E" }}>
          <div data-zoom="1" style={{ position: "absolute", inset: "0", transition: "transform 1.2s cubic-bezier(.16,.84,.24,1)" }}>
            <img src="https://images.pexels.com/photos/24433378/pexels-photo-24433378.jpeg?auto=compress&cs=tinysrgb&w=1800" alt="Planche \xE0 partager sur table en bois (portrait 3:4)" loading="lazy" decoding="async" style={{ display: "block", width: "100%", height: "100%", objectFit: "cover" }} />
          </div>
          <div style={{ position: "absolute", inset: "0", background: "linear-gradient(180deg,rgba(13,14,14,.1) 30%,rgba(13,14,14,.88) 100%)", pointerEvents: "none" }} />
          <div style={{ position: "absolute", inset: "auto 0 0 0", display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 16, padding: "clamp(20px,2vw,32px)", pointerEvents: "none" }}>
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              <h3 style={{ fontFamily: "Teko,Impact,sans-serif", fontWeight: "600", fontSize: "clamp(28px,2.6vw,44px)", lineHeight: "1", textTransform: "uppercase", color: "#FFFFFF" }}>&Agrave; partager</h3>
              <p style={{ maxWidth: 230, fontSize: 13, lineHeight: "1.7", fontWeight: "300", color: "rgba(242,239,232,.7)" }}>Ce qu&rsquo;on met au centre de la table, entre amis.</p>
            </div>
            <span data-arrow-glyph="1" style={{ flex: "none", fontSize: 20, color: "#FBE275", transition: "transform .6s cubic-bezier(.16,.84,.24,1)" }}>&rarr;</span>
          </div>
        </a>
    ...
    <div id="m1000-siggrid" style={{ position: "relative", display: "grid", gridTemplateColumns: "7fr 5fr", gap: "clamp(28px,4vw,72px)", alignItems: "center", maxWidth: 1440, margin: "0 auto" }}>
      <div data-reveal="mask" style={{ position: "relative", aspectRatio: "5 / 4", overflow: "hidden" }}>
        <div data-parallax="-0.04" style={{ position: "absolute", inset: "-8%" }}>
          <img src="https://images.pexels.com/photos/36189464/pexels-photo-36189464.jpeg?auto=compress&cs=tinysrgb&w=1800" alt="Gros plan du plat ou cocktail signature (paysage)" loading="lazy" decoding="async" style={{ display: "block", width: "100%", height: "100%", objectFit: "cover" }} />
        </div>
      </div>
    ...
    <div style={{ maxWidth: 1440, margin: "0 auto" }}>
      ...
      <div id="m1000-gallery" style={{ display: "grid", gridTemplateColumns: "repeat(12,1fr)", gap: "clamp(12px,1.4vw,22px)" }}>
        <div data-card="1" data-reveal="mask" data-parallax="-0.03" style={{ gridColumn: "1 / span 5", aspectRatio: "4 / 5", overflow: "hidden", background: "#0D0E0E" }}>
          <div data-zoom="1" style={{ position: "relative", height: "100%", transition: "transform 1.4s cubic-bezier(.16,.84,.24,1)" }}><img src="https://images.pexels.com/photos/3811834/pexels-photo-3811834.jpeg?auto=compress&cs=tinysrgb&w=1800" alt="Le bar central (portrait)" loading="lazy" decoding="async" style={{ display: "block", width: "100%", height: "100%", objectFit: "cover" }} /></div>
        </div>
        <div data-card="1" data-reveal="mask" data-delay="120" data-parallax="0.05" style={{ gridColumn: "6 / span 7", aspectRatio: "16 / 10", overflow: "hidden", background: "#0D0E0E", alignSelf: "end" }}>
          <div data-zoom="1" style={{ position: "relative", height: "100%", transition: "transform 1.4s cubic-bezier(.16,.84,.24,1)" }}><img src="https://images.pexels.com/photos/8980827/pexels-photo-8980827.jpeg?auto=compress&cs=tinysrgb&w=1800" alt="Salle en soir\xE9e (paysage)" loading="lazy" decoding="async" style={{ display: "block", width: "100%", height: "100%", objectFit: "cover" }} /></div>
        </div>
        <div data-card="1" data-reveal="mask" data-delay="80" data-parallax="0.04" style={{ gridColumn: "2 / span 4", aspectRatio: "1 / 1", overflow: "hidden", background: "#0D0E0E", marginTop: "clamp(-40px,-4vw,0px)" }}>
          <div data-zoom="1" style={{ position: "relative", height: "100%", transition: "transform 1.4s cubic-bezier(.16,.84,.24,1)" }}><img src="https://images.pexels.com/photos/17903465/pexels-photo-17903465.jpeg?auto=compress&cs=tinysrgb&w=1800" alt="D\xE9tail du d\xE9cor \u2014 plante ou luminaire (carr\xE9)" loading="lazy" decoding="async" style={{ display: "block", width: "100%", height: "100%", objectFit: "cover" }} /></div>
        </div>
        <div data-card="1" data-reveal="mask" data-delay="200" data-parallax="-0.04" style={{ gridColumn: "6 / span 3", aspectRatio: "3 / 4", overflow: "hidden", background: "#0D0E0E" }}>
          <div data-zoom="1" style={{ position: "relative", height: "100%", transition: "transform 1.4s cubic-bezier(.16,.84,.24,1)" }}><img src="https://images.pexels.com/photos/2104568/pexels-photo-2104568.jpeg?auto=compress&cs=tinysrgb&w=1800" alt="Cocktail (portrait)" loading="lazy" decoding="async" style={{ display: "block", width: "100%", height: "100%", objectFit: "cover" }} /></div>
        </div>
        <div data-card="1" data-reveal="mask" data-delay="280" data-parallax="0.03" style={{ gridColumn: "9 / span 4", aspectRatio: "4 / 3", overflow: "hidden", background: "#0D0E0E", alignSelf: "center" }}>
          <div data-zoom="1" style={{ position: "relative", height: "100%", transition: "transform 1.4s cubic-bezier(.16,.84,.24,1)" }}><img src="https://images.pexels.com/photos/19120151/pexels-photo-19120151.jpeg?auto=compress&cs=tinysrgb&w=1800" alt="Moment de convivialit\xE9 (paysage)" loading="lazy" decoding="async" style={{ display: "block", width: "100%", height: "100%", objectFit: "cover" }} /></div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="histoire" data-screen-label="Notre histoire" style={{ position: "relative", padding: "clamp(90px,14vh,180px) clamp(20px,5vw,80px)", background: "#0D0E0E" }}>
    <div id="m1000-histgrid" style={{ display: "grid", gridTemplateColumns: "5fr 6fr", gap: "clamp(28px,5vw,90px)", alignItems: "center", maxWidth: 1320, margin: "0 auto" }}>
      <div data-reveal="mask" style={{ position: "relative", aspectRatio: "1 / 1", overflow: "hidden" }}>
        <img src="https://images.pexels.com/photos/12181619/pexels-photo-12181619.jpeg?auto=compress&cs=tinysrgb&w=1800" alt="Photo humaine \u2014 service ou \xE9quipe derri\xE8re le bar (carr\xE9)" loading="lazy" decoding="async" style={{ display: "block", width: "100%", height: "100%", objectFit: "cover" }} />
      </div>
      <div style={{ display: "flex", flexDirection: "column", gap: "clamp(16px,1.8vw,26px)" }}>
