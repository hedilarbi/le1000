...
<div id="ap-root" style={{ position: "relative", background: "#0D0E0E" }}><section id="ap-hero" data-screen-label="Hero \xC0 propos" style={{ position: "relative", minHeight: "clamp(560px,86svh,900px)", display: "flex", alignItems: "flex-end", overflow: "hidden" }}>
    <div id="ap-heroimg" style={{ position: "absolute", inset: "-20% 0", transform: "scale(1.05)", willChange: "transform" }}>
      <img src="https://images.pexels.com/photos/6503578/pexels-photo-6503578.jpeg?auto=compress&cs=tinysrgb&w=1800" alt="Photo d'ambiance \u2014 salle vide en fin de journ\xE9e, lumi\xE8re chaude (paysage, 2400px)" loading="lazy" decoding="async" style={{ display: "block", width: "100%", height: "100%", objectFit: "cover" }} />
    </div>
      ...
      <div style={{ position: "relative" }}>
        <div data-reveal="mask" style={{ position: "relative", width: "100%", aspectRatio: "4 / 5", overflow: "hidden" }}>
          <div data-parallax="-0.03" style={{ position: "absolute", inset: "-6%" }}>
            <img src="https://images.pexels.com/photos/12181619/pexels-photo-12181619.jpeg?auto=compress&cs=tinysrgb&w=1800" alt="Photo humaine \u2014 propri\xE9taire ou \xE9quipe au bar (portrait 4:5)" loading="lazy" decoding="async" style={{ display: "block", width: "100%", height: "100%", objectFit: "cover" }} />
          </div>
        </div>
  ...
  <section id="ap-lieu" data-screen-label="Le lieu" style={{ position: "relative", minHeight: "100svh", display: "flex", alignItems: "center", overflow: "hidden", background: "#0D0E0E" }}>
    <div id="ap-lieuimg" style={{ position: "absolute", inset: "-24% 0", willChange: "transform" }}>
      <img src="https://images.pexels.com/photos/5490818/pexels-photo-5490818.jpeg?auto=compress&cs=tinysrgb&w=1800" alt="Grande photo du lieu \u2014 bar central en soir\xE9e (paysage, 2400px)" loading="lazy" decoding="async" style={{ display: "block", width: "100%", height: "100%", objectFit: "cover" }} />
    </div>
    ...
    <div id="ap-teamgrid" style={{ display: "grid", gridTemplateColumns: "5fr 7fr", gap: "clamp(30px,4vw,80px)", alignItems: "center", maxWidth: 1400, margin: "0 auto" }}>
      ...
      <div id="ap-gallery" style={{ display: "grid", gridTemplateColumns: "repeat(12,1fr)", gap: "clamp(12px,1.4vw,20px)" }}>
        <div data-card="1" data-reveal="mask" data-parallax="-0.03" style={{ gridColumn: "1 / span 7", aspectRatio: "4 / 3", overflow: "hidden", background: "#0D0E0E" }}>
          <div data-zoom="1" style={{ position: "relative", height: "100%", transition: "transform 1.4s cubic-bezier(.16,.84,.24,1)" }}><img src="https://images.pexels.com/photos/3811834/pexels-photo-3811834.jpeg?auto=compress&cs=tinysrgb&w=1800" alt="Barman au travail (paysage)" loading="lazy" decoding="async" style={{ display: "block", width: "100%", height: "100%", objectFit: "cover" }} /></div>
        </div>
        ...
        <div data-card="1" data-reveal="mask" data-delay="200" data-parallax="0.04" style={{ gridColumn: "2 / span 5", aspectRatio: "1 / 1", overflow: "hidden", background: "#0D0E0E", marginTop: "clamp(-32px,-3vw,0px)" }}>
          <div data-zoom="1" style={{ position: "relative", height: "100%", transition: "transform 1.4s cubic-bezier(.16,.84,.24,1)" }}><img src="https://images.pexels.com/photos/17903465/pexels-photo-17903465.jpeg?auto=compress&cs=tinysrgb&w=1800" alt="D\xE9tail du d\xE9cor (carr\xE9)" loading="lazy" decoding="async" style={{ display: "block", width: "100%", height: "100%", objectFit: "cover" }} /></div>
        </div>
      </div>
    </div>
  </section>
